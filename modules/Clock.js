    ...
    <div className="grid grid-flow-col gap-6">
      ...
      >
        <div
          ...
          style={{
            ...
            transform: `rotateZ(${time.getHours() * 30 + time.getMinutes() * (6 / 12)}deg)`
          }}
        />
        <div
          className="absolute bg-gray-700 dark:bg-gray-300"
          style={{
            ...
            left: '49%',
            transformOrigin: 'bottom',
            transform: `rotateZ(${time.getMinutes() * 6 + time.getSeconds() * (6 / 60)}deg)`
          }}
        />
        {configuration.showSeconds && <div
        ...
        <div
          className="absolute rounded-full z-20 border-2 border-white dark:border-black bg-gray-700 dark:bg-gray-300"
          style={{
            width: "4%",
            height: "4%",
            top: "50%",
      ...
      <div className="flex flex-col align-center justify-center">
        <span className="text-center text-xl">
          <h2 className="font-extrabold">{time.getHours()}:{String(time.getMinutes()).padStart(2, '0')}{configuration.showSeconds && ":" + String(time.getSeconds()).padStart(2, '0')}</h2>
          <h3>{time.toLocaleDateString(undefined, { weekday: 'long', year: 'numeric', month: 'long', day: 'numeric' })}</h3>
        </span>
      </div>
    </div>
  );
