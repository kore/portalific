...
export default function ClockConfiguration({ configuration, setConfiguration }) {
  return (
    <Fragment>
      {/* Main section */}
      <div className="pt-6 divide-y divide-gray-200 dark:divide-gray-600">
        <div className="px-4 sm:px-6">
          <div>
            <h2 className="text-lg leading-6 font-medium text-gray-900 dark:text-gray-100">Clock</h2>
            <p className="mt-1 text-sm text-gray-500 dark:text-gray-300">
              A simple (optionally analogue) watch displaying the current time and date.
            </p>
          </div>
            ...
            <Switch.Group as="li" className="py-4 flex items-center justify-between">
              ...
              >
                <span
                  aria-hidden="true"
                  className={classNames(
                    configuration.showAnalogue ? 'translate-x-5' : 'translate-x-0',
            ...
            <Switch.Group as="li" className="py-4 flex items-center justify-between">
              ...
              >
                <span
                  aria-hidden="true"
                  className={classNames(
                    configuration.showSeconds ? 'translate-x-5' : 'translate-x-0',
                    'inline-block h-5 w-5 rounded-full bg-white shadow transform ring-0 transition ease-in-out duration-200'
                  )}
                />
              </Switch>
